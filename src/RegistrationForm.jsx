...
function RegistrationForm({ onComplete }) {
  ...
  // Watch the values for phone code and phone number separately
  ...
  // Calculate progress percentage (3 steps)
        ...
        {step === 2 && (
          <div className="space-y-6">
            <div>
              ...
              />
              <p className="text-xs text-red-500 mt-1">Number not confirmed</p>
            </div>
            <div>
